...
public class Agdistis {
	...
	public Agdistis() {
		endpoint = "http://fox.cs.uni-paderborn.de:4444/#!/home";
	...
	protected String send(final String agdistis_input) throws Exception {
		...
		final String urlParameters = "text=" + URLEncoder.encode(agdistis_input, "UTF-8")
				+ "&type=agdistis&heuristic=false";
	...
	protected String urlencode(final String disambiguatedURL) {
		try {
			final String encode = URLEncoder.encode(
